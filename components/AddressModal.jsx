...
const AddressModal = ({ setShowAddressModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // notify other components (e.g., checkout) about the new address
            try {
                if (typeof window !== 'undefined' && window.dispatchEvent) {
                    window.dispatchEvent(new CustomEvent('address:created', { detail: savedAddress }))
                }
            } catch (e) {
                // ignore
            }
    ...
    return (
        <form onSubmit={e => toast.promise(handleSubmit(e), {
            ...
            error: (err) => err?.message || 'Failed to add address'
