...
export default function AddProduct() {
  const [form, setForm] = useState({ name: '', description: '', mrp: '', price: '', category: '', categoryId: '', images: [], inStock: true, featured: false, latest: false, bestSelling: false, colors: [], sizes: [] })
  ...
  return (
    <div className="text-slate-600 mb-20 sm:p-4 max-w-6xl mx-auto">
      <div className="flex items-center gap-3 mb-4">
        <div className="flex h-14 w-14 items-center justify-center rounded-3xl bg-emerald-50 text-emerald-600 shadow-sm shrink-0">
          <PackagePlus size={24} />
        </div>
